...
Hooks.once("setup", function() {
  ...
  const toLocalize = [
    "abilities", "abilityAbbreviations", "abilityActivationTypes", "abilityConsumptionTypes", "actorSizes", "shadowweaknesses",
  ...
  const noSort = [
    "abilities", "shadowweaknesses", "currencies", "distanceUnits", "movementUnits", "itemActionTypes", "proficiencyLevels",
...
Hooks.once("ready", function() {
  ...
  const NEEDS_MIGRATION_VERSION = "1.003";
...
Hooks.on("canvasInit", function() {
  ...
  canvas.grid.diagonalRule = game.settings.get("aime", "diagonalMovement");
...
Hooks.on("renderChatMessage", (app, html, data) => {
  ...
  if (game.settings.get("aime", "autoCollapseItemCards")) html.find(".card-content").hide();
});
